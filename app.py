        ...
        html += """<div style="border: 2px solid #ccc; padding: 15px; border-radius: 8px; margin-bottom: 20px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="border: 1px solid #ccc; padding: 8px;">· 건물의 형태와 주변 환경을 고려하여 특정 주제나 전달하고자 하는 메시지에 맞춘 디자인을 구상한다.<br>· 건축물의 외벽에 프로젝션, LED 스크린, 조명 등 다양한 기술을 활용하여 작품 구현</td>
                </tr>
            </table>
        </div>"""
...
def render_activity3_3th(user_key, u_info, current_role):
    ...
    change_df = pd.DataFrame(ans.get("change_df", [{"어떤 국가에 대해?": "", "현재 편견": "", "올바른 정보를 찾기 위한 계획": ""} for _ in range(2)]))
